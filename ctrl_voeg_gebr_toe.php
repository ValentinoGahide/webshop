...
if (isset($_GET["action"])) {
    if ($_GET["action"] == "process") {
        ...
        //
        try {
            GebruikerinfoService::Bestaat_Nieuwe_Gebr_al($_POST["usernaam"]);
        ...
        GebruikerinfoService::voegNieuweGebrToe
                ($_POST["naam"], $_POST["usernaam"], sha1($_POST["wachtwoord"]), 0, $_POST["adres"], $_POST["email"], $_POST["telefoon"], 1, $date, $_POST["postcode_id"], 0, $_POST["opm_extra"], $_POST["btwnr"]
        );
        setcookie("aangemeld", $_POST["usernaam"], time() + 3600);
